...
//     try {
//       const res = await fetch('/api/auth/doctor/signin', {
//         method: 'POST',
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={form.mobile}
                  onChange={handleChange}
                  className="appearance-none block w-full pl-16 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-all duration-200"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={form.password}
                  onChange={handleChange}
                  className="appearance-none text-gray-800 block w-full px-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm pr-10 transition-all duration-200"
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Doctor Portal?</span>
              </div>
            </div>
            ...
            <div className="mt-4 text-center">
              ...
              >
                Are you medical staff? Sign in here →
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-white rounded-lg p-6 shadow border border-blue-100">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Doctor Portal Features</h3>
              <p className="text-sm text-gray-600">Everything you need for patient care</p>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">
            For emergency access, contact admin: admin@medicare.com
          </p>
        </div>
      </div>
    </div>
